...
class alumno{
    ...
    private function almacenar_alumno(){
        if( $this->resp['msg']==='correcto' ){
            if( $this->datos['accion']==='nuevo' ){
                ...
                $this->db->consultas('
                 UPDATE alumno SET (codigo,nombre,direccion,telefono) VALUES(
            ...
            ');
            $this->resp['msg'] = 'Registro actualizado correctamente';
            }
        }
    }
    public function buscar($valor=''){
        $this->db->consultas('
            ...
            from alumnos
            where alumnos.codigo like "%'.$valor.'%" or alumnos.nombre like "%
        ')
    ...
    public function eliminarAlumno($idAlumno=''){
        $this->db->consultas('
            ...
            ')
            $this->resp['msg'] = 'Registro eliminado correctamente';
